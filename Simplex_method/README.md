...
| --- | --- |
| `in_data()` | 問題データの入力 |
| `create_initial_tableau()` | タブロ作成 |
| `phase1()` | 実行可能性判定 |
| `phase2()` | 最適解探索 |
| `pivot()` | ピボット操作 |
| `determine_entering_variable()` | 基底変数の決定 |
| `determine_leaving_variable()` | 非基底変数の決定 |
| `print_answer()` | 最適解の表示 |
...
```
目的関数
z = -2.000000x_1 + 3.000000x_2 + -6.000000x_3 + -1.000000x_4 + 2.000000x_5 + 0.000000  (最大化)

制約条件
2.000000x_1 + -3.000000x_2 + 1.000000x_3 + 3.000000x_4 + -1.000000x_5 = 3.000000
1.000000x_1 + 1.000000x_2 + -2.000000x_3 + 9.000000x_4 + 0.000000x_5 = 4.000000
x_i>= 0  (i = 1,2,...,5)
```
